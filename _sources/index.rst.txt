...
.. grid:: 1 2 2 4
	...
	:link: installation
        ...
        :img-background: _static/Installation_logo_SMSPSA.svg

    .. grid-item-card::
        :link: userguide
        :link-type: ref
        :link-alt: User guide
        :img-background: _static/Userguide_logo_SMSPSA.svg

    .. grid-item-card::
        :link: api
        :link-type: ref
        :link-alt: API reference
        :img-background: _static/API_logo_SMSPSA.svg

    .. grid-item-card::
        :link: releases
        :link-type: ref
        :link-alt: Releases
        :img-background: _static/Releases_logo_SMSPSA.svg
